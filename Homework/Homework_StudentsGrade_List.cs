...
namespace Homework
{
    public partial class Homework_StudentsGrade_List : Form
    {
        public Homework_StudentsGrade_List()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            //L>Chinese> R
            int L = int.Parse(txtRangeLeft.Text);
            int R = int.Parse(txtRangeRight.Text);
            labName.Text = "";
            for (i = 0; i < boxpro.Count; i++)
            {
                if (L > ((Product)boxpro[i]).GradeChinese && ((Product)boxpro[i]).GradeChinese>R)
                {
                    ...
                    labName.Text += $"{FixedWidth(name, 28, true)}{FixedWidth(resultC, 3, false)}{FixedWidth(resultE, 23, false)}{FixedWidth(resultM, 20, false)}" +
                                    $"{FixedWidth(resultTotal, 22, false)}{FixedWidth(resultAvg, 19, false)}{FixedWidth(LNa, 18, false)}{FixedWidth(HNa, 16, false)}\n";
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            if (boxpro.Count > 1)
            {
                ...
                bool isNumM = int.TryParse(txtEnglish.Text, out int math);
        ...
        {
            label5.Text = $"{FixedWidth("姓名", 10, true)}{FixedWidth("國文", 8, true)}{FixedWidth("英文", 8, true)}{FixedWidth("數學", 8, true)}" +
              $"{FixedWidth("總分", 8, true)}{FixedWidth("平均", 8, true)}{FixedWidth("最低", 8, true)}{FixedWidth("最高", 0, true)}";
        }
